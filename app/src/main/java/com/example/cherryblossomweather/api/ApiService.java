package com.example.cherryblossomweather.api;
...
import com.example.cherryblossomweather.bean.MoreAirFiveResponse;
...
import static com.example.cherryblossomweather.utils.Constant.API_KEY;
import static com.example.cherryblossomweather.utils.Constant.UPDATE_API_TOKEN;
import static com.example.cherryblossomweather.utils.Constant.UPDATE_USER_ID;
...
public interface ApiService {
    /**
     * https://free-api.heweather.net/s6/weather/now?key="+API_KEY+"&location=xx
     ...
     * 未来3 - 7天天气预报
     */
   /* @GET("/s6/weather/forecast?key=83402386a0ab4de49522a32f1af3968d")
